                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="maiden_name" value="{{ Auth::User()->maiden_name}}">
                                        </div>
                                ...
                                <div class="col-md-10">
                                    <div class="col-md-10">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" name="btn" id="btn" class="btn btn-template-main"><i class="fa fa-check-circle"></i> Next</button>
                                        </div>
                                        <br><br>
                                    </div>
                                </div>
