		...
		<div class="dpr-well">
			...
			<div class="data">
				...
				<p class="lead" id="dpr-pf-name">
					...
					<br>Application Status: @if($user->approved=="1") <span class="label label-success">Approved</span> @else <span  class="label label-warning" >Pending </span> @endif
					<br>
					<strong class="text-danger">Reference Number: {{ $user->ref_num }}</strong>
					<br>
					
    <a  onclick="window.print()" class="" style="color:black; cursor:pointer; text-decoration:none;"><i class="fa fa-print"></i> Print</a>
				</p>
			</div>
			<div id="demo"></div>
		</div>
		...
		<div class="dpr-well">
			<div class="data">
				<h3 class="text-uppercase text-primary">
					...
					<button class="btn btn-primary pull-right" type="button" data-toggle="modal" data-target="#biodataModal" >Edit</button>
				</h3>
				<div class="col-lg-6">
					<p class="lead" id="dpr-pf-name">
						...
						<br>Reference Number: {{ $user->ref_num }}<br>
		...
		<div class="dpr-well">
			<div class="data">
				<h3 class="text-uppercase text-primary">
					...
					<button class="btn btn-primary pull-right" type="button" data-toggle="modal" data-target="#contactModal" >Edit</button>
				</h3>
				<div class="col-lg-6">
					<p class="lead" id="dpr-pf-name">
		...
		<div class="dpr-well">
			<div class="data">
				<h3 class="text-uppercase text-primary">
					...
					<button class="btn btn-primary pull-right" type="button" data-toggle="modal" data-target="#educationModal" >Edit</button>
				</h3>
				<div class="col-lg-6">
					<p class="lead" id="dpr-pf-name">
	...
	<div class="col-lg-12">
		<div class="dpr-well">
			<div class="data">
				<h3 class="text-uppercase text-primary">
					<i class="fa fa-mortar-board"></i> Professional Qualifications 
					<button class="btn btn-primary pull-right" type="button" data-toggle="modal" data-target="#qualificationModal" >Add</button>
				</h3>
				<p class="lead" id="dpr-pf-name">
		...
		<div class="dpr-well">
			<div class="data">
				<h3 class="text-uppercase text-primary">
					...
					<button class="btn btn-primary pull-right" type="button" data-toggle="modal" data-target="#relevantexpModal" >Add</button>
				</h3>
				<div class="table-responsive">
					<table class="table table-hover table-stripped">
						<thead>
	...
	<div class="col-lg-12">
		<div class="dpr-well">
			<div class="data">
				<h3 class="text-uppercase text-primary">
					<i class="fa fa-users"></i> Referees 
					<button class="btn btn-primary pull-right" type="button" data-toggle="modal" data-target="#refereesModal" >Add</button>
				</h3>
				<p class="lead" id="dpr-pf-name">
					No Referees Found!
				</p>
                             ...
                             <div class="col-md-10">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12" style="margin-left:-15px;">
                                            ...
                                            <button type="submit" name="btn" id="btned" class="btn btn-template-main"><i class="fa fa-check-circle"></i> Save</button>
